...
class Roles(commands.Cog):
    ...
    @commands.command(aliases=['getRoles'],
                      help='Get a list of all roles on the server.\ne.g.\n`!allRoles`')
    ...
    @commands.command(aliases=['addrl'],
                      help='Add a new role-link connection.\ne.g.\n`!addRoleLink @roleName https://www.google.com/`')
    ...
    @commands.command(aliases=['getrl', 'getrls'],
                      help='Get a list of all role-links on the server.\ne.g.\n`!getRoleLinks`')
    ...
    @commands.command(aliases=['saverl', 'saverls'],
                      help='Only the Bot-Owner can save the role-links.\ne.g.\n`!saveRoleLinks`')
    @commands.is_owner()
